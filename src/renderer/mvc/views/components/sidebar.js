    ...
    this.setTemplate(`
      <aside class="sidebar">
        ...
        <div class="sidebar__footer">
          <button class="btn btn--primary btn--sm" id="check-update-btn" style="width: 100%; margin-bottom: 10px; display: flex; align-items: center; justify-content: center; gap: 6px;">
          ...
          <div id="update-status" style="font-size: 12px; text-align: center; margin-bottom: 10px; display: none; padding: 8px 12px; border-radius: var(--radius-md); background: var(--color-bg-secondary); border: 1px solid var(--color-border);">
            <!-- Update status will be displayed here -->
          </div>
          <div style="font-size: 11px; color: var(--color-text-muted); text-align: center; line-height: 1.4;">
            <div style="font-weight: 600; color: var(--color-text-secondary);" id="app-version"></div>
            <div style="margin-top: 2px;">Developed by Reysilva</div>
          </div>
          <div style="margin-top: 8px; display: flex; align-items: center; justify-content: center; gap: 6px; color: var(--color-warning); font-size: 10px; font-weight: 500;">
